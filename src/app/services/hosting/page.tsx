...
export const metadata: Metadata = {
  title: "Website Hosting & Domain Management in East Tennessee",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Website Hosting & Domain Management",
  description: "Fast, reliable managed hosting and domain management for small business websites in Lenoir City, Loudon, Knoxville, and East Tennessee.",
  provider: {
