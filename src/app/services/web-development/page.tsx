...
export const metadata: Metadata = {
  title: "Custom Web Design in Lenoir City, TN",
...
const jsonLd = {
  ...
  description: "We build fully custom, mobile-ready, SEO-optimized websites for small businesses in Lenoir City, Loudon, Knoxville, and East Tennessee.",
  provider: {
